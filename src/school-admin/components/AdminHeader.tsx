    ...
    return (
        <header className="h-14 bg-white border-b border-gray-100 flex items-center justify-between px-6">
            ...
            <div className="flex items-center gap-4">
                {/* Site Editor Button */}
                <Link href="/editor">
                    <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#C4A35A] to-[#8B7355] text-white font-medium rounded-lg hover:shadow-lg transition-all">
