...
export default function Footer({ initialData = null }: FooterProps) {
    ...
    const { links: footerLinks, socialLinks: socialData } = data;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
                        ...
                        <div className="flex items-center justify-center md:justify-end gap-4">
                            ...
                            <div>
                                ...
                                <div className="font-semibold">{data.contact.address}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
                    ...
                    >
                        <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
                            {data.logo?.image ? (
                                <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-[#C4A35A]">
